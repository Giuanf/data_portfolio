...
const Navbar = ({open}) => {
  ...
  return (
    <Ul open={open}>
      {!loading && (<>
        <NavLink to="/data_portfolio/home" className={"btnHMenu"}>Home</NavLink>
        <NavLink to="/data_portfolio/personal" className={"btnHMenu"}>{data.personal}</NavLink>
        <NavLink to="/data_portfolio/professional"className={"btnHMenu"}>{data.professional}</NavLink>
