...
const EditPostForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/data_portfolio/personal')
  }
    ...
    <div>
      ...
      <form className='createForm'>
        ...
        <div className='divNavForm'>
          <NavLink to="/data_portfolio/home" className= "linkEdit">Home</NavLink>
          <NavLink to="/data_portfolio/personal" className= "linkEdit">{data.personal}</NavLink>
        </div>
      </form>
    </div>
  )
