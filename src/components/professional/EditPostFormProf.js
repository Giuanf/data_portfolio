...
const EditPostFormProf = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/data_portfolio/professional')
  }
    ...
    <div>
      ...
      <form className='createForm'>
        ...
        <div className='divNavFormProf'>
          <NavLink to="/data_portfolio/home" className= "linkEditProf">Home</NavLink>
          <NavLink to="/data_portfolio/professional" className= "linkEditProf">{data.professional}</NavLink>
        </div>
      </form>
    </div>
  )
