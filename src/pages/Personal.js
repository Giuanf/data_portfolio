    ...
    <div>
      <nav className='navPersonal'>
        ...
        <ul className='listMenuPage'>
          <NavLink to="/data_portfolio/home">Home</NavLink>
          <NavLink to="/data_portfolio/personal">{data.personal}</NavLink>
          <NavLink to="/data_portfolio/professional">{data.professional}</NavLink>
